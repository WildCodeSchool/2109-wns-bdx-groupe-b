...
describe("Server", function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, apollo_server_1.default)()];
                case 1:
                    server = _a.sent();
                    return [2 /*return*/];
            }
    ...
    beforeEach(function () { return (0, typeorm_1.createConnection)(); });
    afterEach(function () { return (0, typeorm_1.getConnection)().close(); });
    describe("query projects", function () {
        var GET_PROJECTS = "\n    query {\n      projects {\n        id\n        name\n        description\n        status\n        dueDate\n        thumbnailPath\n        initialTimeSpent\n        totalTimeSpent\n        percentageTimeSpent\n        percentageTimeAccomplished\n      }\n    }";
        describe("when there are no projects in database", function () {
            it("returns empty array", function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, server.executeOperation({
                                query: GET_PROJECTS,
                            })];
                        case 1:
                            result = _b.sent();
                            expect(result.errors).toBeUndefined();
                            expect((_a = result.data) === null || _a === void 0 ? void 0 : _a.projects).toEqual([]);
                            return [2 /*return*/];
                    }
                });
            }); });
